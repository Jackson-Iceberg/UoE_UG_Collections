...
public class GetFeatureCollection {
    ...
    /**
     * 
     * @param ArrayList<Position> path - list of positions (flight path of the drone)
     * @return FeatureCollection of the path
     * featurecollection - FeatureCollection object to be added with the list of positions
     * It will form the drone path features
     */
    ...
    /**
     * 
     * @return Features of the out Boundary
     * It is the confinement area as the document requested
     *
     */
...
/**
 * 
 * @param sensorList (ArrayList<Sensor>)
 * @return Features of the sensors.
 * @throws IOException
